...
class PluginLibrary extends _structs_plugin__WEBPACK_IMPORTED_MODULE_2__["default"] {
    ...
    constructor() {
        ...
        const hasLegacySettingsApi =
            typeof BdApi?.isSettingEnabled === "function" &&
            typeof BdApi?.disableSetting === "function" &&
            typeof BdApi?.enableSetting === "function";
        const wasEnabled = hasLegacySettingsApi ? BdApi.isSettingEnabled("settings", "general", "showToasts") : false;
